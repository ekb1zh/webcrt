  ...
  return (
    <article className="card">
      <div className="images">
        <img className="photo" src="1.jpg" alt="photo" />
        <svg className="like" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
      ...
      <div className="info">
        ...
        <p className="address">Адрес: {address}</p>
